...
export default function FooterGlow() {
  return (
    <footer className="relative z-10 mt-8 w-full overflow-hidden pt-16 pb-8 bg-foreground text-background">
      <div className="relative mx-auto flex max-w-6xl flex-col items-center gap-8 rounded-2xl border border-border bg-card/80 backdrop-blur-sm px-6 py-10 md:flex-row md:items-start md:justify-between md:gap-12">
        <div className="flex flex-col items-center md:items-start">
          <a href="#" className="mb-4 flex items-center gap-2">
            <Image src="/logo.png" alt="Studio Veritas" width={36} height={36} className="h-9 w-auto rounded-sm bg-primary/10 p-0.5" />
          ...
          <p className="text-foreground mb-6 max-w-xs text-center text-sm md:text-left">
            Studio Veritas offre competenza notarile per atti immobiliari, societari, successioni e donazioni, con chiarezza e tempi certi.
          </p>
        ...
        <nav className="flex w-full flex-col gap-9 text-center md:w-auto md:flex-row md:justify-end md:text-left">
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/servizi" className="text-foreground/70">
                  Atti Immobiliari
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/chi-siamo" className="text-foreground/70">
                  Lo Studio
                </a>
              </li>
              <li>
                <a href="/contatti" className="text-foreground/70">
                  Contatti
                </a>
              </li>
            </ul>
      ...
      <div className="text-foreground relative z-10 mt-10 text-center text-xs">
        <span>&copy; 2025 Studio Veritas. Tutti i diritti riservati.</span>
      </div>
    </footer>
  );
}
